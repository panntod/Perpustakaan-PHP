...
<div class="container" style="min-height: 100vh; padding-top: 5rem;">
            ...
            if (isset($_SESSION['cart']) && !empty($_SESSION['cart'])) {
                foreach (@$_SESSION['cart'] as $key_produk => $val_produk):
                    ...
                    <tr>
                        ...
                        <td><a href="../backend/proses_hapus_cart.php?id=<?= $key_produk ?>" class="btn btn-danger"><strong>X</strong></a></td>
                    </tr>
    ...
    <a href="../backend/checkout.php" class="btn btn-danger">Check Out</a>
</div>
<?php
include "footer.php";
?>