        ...
        <tbody>
            ...
            while ($dt_histori = mysqli_fetch_array($qry_histori)) {
                ...
                if (mysqli_num_rows($qry_cek_kembali) > 0) {
                    ...
                    $button_kembali = "<a href='../backend/proses_pengembalian_buku.php?id=" . $dt_histori['id_peminjaman_buku'] . "' class='btn btn-warning' onclick='return confirm(\"Apakah kamu yakin ingin mengembalikan\")'>Kembalikan</a>";
                }
                ?>
                <tr>
                    <td>
