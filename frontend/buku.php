...
<div class="container" style="min-height: 100vh; padding: 5rem 0">
                    ...
                    <div class="card-body">
                        ...
                        <?php if ($_SESSION['role'] == 'admin'): ?>
                            <div class="d-flex mt-3">
                                ...
                                <a href="../backend/proses_hapus_buku.php?id_buku=<?= $dt_buku['id_buku'] ?>" class="btn btn-danger w-50 ms-3"><i
